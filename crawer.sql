...
Source Database       : crawer

Target Server Type    : MYSQL
Target Server Version : 50636
File Encoding         : 65001

Date: 2019-08-19 21:47:36
*/
...
-- Records of admin
-- ----------------------------
INSERT INTO `admin` VALUES ('1', 'admin', 'Admin', '53e68813bea5cdd8836aefac62453067', '8f7e1c', '/assets/img/avatar.png', 'xcx_legender@qq.com', '0', '1566139591', '1492186163', '1566139591', '90ead70b-4bb6-44cc-b727-7fad3adc57fb', 'normal');
...
CREATE TABLE `admin_log` (
  ...
  PRIMARY KEY (`id`),
  KEY `name` (`username`)
) ENGINE=InnoDB AUTO_INCREMENT=32 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='管理员日志表';

-- ----------------------------
-- Records of admin_log
-- ----------------------------
INSERT INTO `admin_log` VALUES ('1', '1', 'admin', '/index.php/admin/index/login', '登录', '{\"__token__\":\"e0dbd7bf354783c8859cb643672376ff\",\"username\":\"admin\",\"captcha\":\"YU8W\",\"keeplogin\":\"1\"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/75.0.3770.142 Safari/537.36', '1565095625');
INSERT INTO `admin_log` VALUES ('2', '1', 'admin', '/index.php/admin/addon/install', '插件管理 安装', '{\"name\":\"database\",\"force\":\"0\",\"uid\":\"0\",\"token\":\"\",\"version\":\"1.0.5\",\"faversion\":\"1.0.0.20190705_beta\"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/75.0.3770.142 Safari/537.36', '1565095659');
INSERT INTO `admin_log` VALUES ('3', '1', 'admin', '/index.php/admin/index/index', '', '{\"action\":\"refreshmenu\"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/75.0.3770.142 Safari/537.36', '1565095659');
INSERT INTO `admin_log` VALUES ('4', '1', 'admin', '/index.php/admin/addon/config?name=database&dialog=1', '插件管理 配置', '{\"name\":\"database\",\"dialog\":\"1\",\"row\":{\"backupDir\":\"..\\/data\\/\",\"backupIgnoreTables\":\"fa_admin_log\"}}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/75.0.3770.142 Safari/537.36', '1565095686');
INSERT INTO `admin_log` VALUES ('5', '1', 'admin', '/index.php/admin/general.database/query', '常规管理 数据库管理 查询', '{\"do_action\":\"viewdata\",\"tablename\":[\"user\"],\"submit2\":\"\\u67e5\\u770b\\u8868\\u6570\\u636e\"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/75.0.3770.142 Safari/537.36', '1565095703');
INSERT INTO `admin_log` VALUES ('6', '1', 'admin', '/index.php/admin/addon/install', '插件管理 安装', '{\"name\":\"crontab\",\"force\":\"0\",\"uid\":\"0\",\"token\":\"\",\"version\":\"1.0.2\",\"faversion\":\"1.0.0.20190705_beta\"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/75.0.3770.142 Safari/537.36', '1565095744');
INSERT INTO `admin_log` VALUES ('7', '1', 'admin', '/index.php/admin/index/index', '', '{\"action\":\"refreshmenu\"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/75.0.3770.142 Safari/537.36', '1565095744');
INSERT INTO `admin_log` VALUES ('8', '1', 'admin', '/index.php/admin/general/crontab/get_schedule_future', '', '{\"schedule\":\"* * * * *\",\"days\":\"7\"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/75.0.3770.142 Safari/537.36', '1565095756');
INSERT INTO `admin_log` VALUES ('9', '1', 'admin', '/index.php/admin/general/crontab/get_schedule_future', '', '{\"schedule\":\"* * * * *\",\"days\":\"7\"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/75.0.3770.142 Safari/537.36', '1565095763');
INSERT INTO `admin_log` VALUES ('10', '1', 'admin', '/index.php/admin/addon/install', '插件管理 安装', '{\"name\":\"log\",\"force\":\"0\",\"uid\":\"0\",\"token\":\"\",\"version\":\"1.0.2\",\"faversion\":\"1.0.0.20190705_beta\"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/75.0.3770.142 Safari/537.36', '1565095801');
INSERT INTO `admin_log` VALUES ('11', '1', 'admin', '/index.php/admin/index/index', '', '{\"action\":\"refreshmenu\"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/75.0.3770.142 Safari/537.36', '1565095801');
INSERT INTO `admin_log` VALUES ('12', '1', 'admin', '/index.php/admin/addon/install', '插件管理 安装', '{\"name\":\"summernote\",\"force\":\"0\",\"uid\":\"0\",\"token\":\"\",\"version\":\"1.0.4\",\"faversion\":\"1.0.0.20190705_beta\"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/75.0.3770.142 Safari/537.36', '1565095883');
INSERT INTO `admin_log` VALUES ('13', '1', 'admin', '/index.php/admin/index/index', '', '{\"action\":\"refreshmenu\"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/75.0.3770.142 Safari/537.36', '1565095883');
INSERT INTO `admin_log` VALUES ('14', '1', 'admin', '/index.php/admin/auth/rule/multi/ids/4', '', '{\"action\":\"\",\"ids\":\"4\",\"params\":\"ismenu=0\"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/75.0.3770.142 Safari/537.36', '1565095920');
INSERT INTO `admin_log` VALUES ('15', '1', 'admin', '/index.php/admin/index/index', '', '{\"action\":\"refreshmenu\"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/75.0.3770.142 Safari/537.36', '1565095921');
INSERT INTO `admin_log` VALUES ('16', '1', 'admin', '/index.php/admin/user/user/edit/ids/1?dialog=1', '会员管理 会员管理 编辑', '{\"dialog\":\"1\",\"row\":{\"group_id\":\"1\",\"username\":\"admin\",\"nickname\":\"admin\",\"password\":\"111111\",\"email\":\"admin@163.com\",\"mobile\":\"13888888888\",\"avatar\":\"\",\"level\":\"0\",\"gender\":\"0\",\"birthday\":\"2017-04-15\",\"bio\":\"\",\"money\":\"0.00\",\"score\":\"0\",\"successions\":\"1\",\"maxsuccessions\":\"1\",\"prevtime\":\"2018-01-17 14:28:12\",\"logintime\":\"2018-01-17 14:46:54\",\"loginip\":\"127.0.0.1\",\"loginfailure\":\"0\",\"joinip\":\"127.0.0.1\",\"jointime\":\"2017-04-06 14:50:18\",\"status\":\"normal\"},\"ids\":\"1\"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/75.0.3770.142 Safari/537.36', '1565096580');
INSERT INTO `admin_log` VALUES ('17', '1', 'admin', '/index.php/admin/general.config/edit', '常规管理 系统配置 编辑', '{\"row\":{\"name\":\"\\u8bdd\\u957f\\u5e73\\u53f0\",\"beian\":\"\",\"cdnurl\":\"\",\"version\":\"1.0.1\",\"timezone\":\"Asia\\/Shanghai\",\"forbiddenip\":\"\",\"languages\":\"{\\\"backend\\\":\\\"zh-cn\\\",\\\"frontend\\\":\\\"zh-cn\\\"}\",\"fixedpage\":\"dashboard\"}}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/75.0.3770.142 Safari/537.36', '1565096609');
INSERT INTO `admin_log` VALUES ('18', '1', 'admin', '/index.php/admin/general.config/edit', '常规管理 系统配置 编辑', '{\"row\":{\"name\":\"\\u8bdd\\u5145\\u7f51\\u5385\\u5e73\\u53f0\",\"beian\":\"\",\"cdnurl\":\"\",\"version\":\"1.0.1\",\"timezone\":\"Asia\\/Shanghai\",\"forbiddenip\":\"\",\"languages\":\"{\\\"backend\\\":\\\"zh-cn\\\",\\\"frontend\\\":\\\"zh-cn\\\"}\",\"fixedpage\":\"dashboard\"}}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/75.0.3770.142 Safari/537.36', '1565096622');
INSERT INTO `admin_log` VALUES ('19', '1', 'admin', '/index.php/admin/category/del/ids/13,12,5,7,11,10,6,9,8,2,4,3,1', '分类管理 删除', '{\"action\":\"del\",\"ids\":\"13,12,5,7,11,10,6,9,8,2,4,3,1\",\"params\":\"\"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/75.0.3770.142 Safari/537.36', '1565096645');
INSERT INTO `admin_log` VALUES ('20', '1', 'admin', '/admin/category/add?dialog=1', '分类管理 添加', '{\"dialog\":\"1\",\"row\":{\"type\":\"default\",\"pid\":\"0\",\"name\":\"1\",\"nickname\":\"2\",\"image\":\"\",\"keywords\":\"\",\"description\":\"3\",\"weigh\":\"0\",\"status\":\"normal\",\"flag\":[\"\"]}}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/75.0.3770.142 Safari/537.36', '1565097201');
INSERT INTO `admin_log` VALUES ('21', '1', 'admin', '/admin/category/del/ids/14', '分类管理 删除', '{\"action\":\"del\",\"ids\":\"14\",\"params\":\"\"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/75.0.3770.142 Safari/537.36', '1565097217');
INSERT INTO `admin_log` VALUES ('22', '1', 'admin', '/admin/general.config/edit', '常规管理 系统配置 编辑', '{\"row\":{\"categorytype\":\"{\\\"default\\\":\\\"Default\\\"}\",\"configgroup\":\"{\\\"basic\\\":\\\"Basic\\\",\\\"email\\\":\\\"Email\\\",\\\"dictionary\\\":\\\"Dictionary\\\",\\\"user\\\":\\\"User\\\",\\\"example\\\":\\\"Example\\\"}\"}}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/75.0.3770.142 Safari/537.36', '1565097235');
INSERT INTO `admin_log` VALUES ('23', '1', 'admin', '/admin/general.config/edit', '常规管理 系统配置 编辑', '{\"row\":{\"categorytype\":\"{\\\"default\\\":\\\"Default\\\"}\",\"configgroup\":\"{\\\"basic\\\":\\\"Basic\\\",\\\"email\\\":\\\"Email\\\",\\\"dictionary\\\":\\\"Dictionary\\\",\\\"user\\\":\\\"User\\\"}\"}}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/75.0.3770.142 Safari/537.36', '1565097248');
INSERT INTO `admin_log` VALUES ('24', '1', 'admin', '/admin/general.database/query', '常规管理 数据库管理 查询', '{\"do_action\":\"viewinfo\",\"tablename\":[\"user\"]}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/75.0.3770.142 Safari/537.36', '1565097284');
INSERT INTO `admin_log` VALUES ('25', '1', 'admin', '/admin/general.database/query', '常规管理 数据库管理 查询', '{\"do_action\":\"viewinfo\",\"tablename\":[\"user\"]}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/75.0.3770.142 Safari/537.36', '1565097285');
INSERT INTO `admin_log` VALUES ('26', '1', 'admin', '/admin/user/group/edit/ids/1?dialog=1', '会员管理 会员分组 编辑', '{\"dialog\":\"1\",\"row\":{\"rules\":\"11,10,9,12,7,6,5,8,4,2,3,1\",\"name\":\"\\u4e0b\\u6e38\",\"code\":\"default\",\"status\":\"normal\"},\"ids\":\"1\"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/75.0.3770.142 Safari/537.36', '1565098559');
INSERT INTO `admin_log` VALUES ('27', '1', 'admin', '/admin/auth/rule/multi/ids/4', '', '{\"action\":\"\",\"ids\":\"4\",\"params\":\"ismenu=1\"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/75.0.3770.142 Safari/537.36', '1565099027');
INSERT INTO `admin_log` VALUES ('28', '1', 'admin', '/admin/index/index', '', '{\"action\":\"refreshmenu\"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/75.0.3770.142 Safari/537.36', '1565099028');
INSERT INTO `admin_log` VALUES ('29', '0', 'Unknown', '/admin/index/login?url=%2Fadmin', '', '{\"url\":\"\\/admin\",\"__token__\":\"a698c7253623dab46f5ce7a3468a9213\",\"username\":\"admin\",\"captcha\":\"vi48\"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/76.0.3809.100 Safari/537.36', '1566139578');
INSERT INTO `admin_log` VALUES ('30', '0', 'Unknown', '/admin/index/login?url=%2Fadmin', '', '{\"url\":\"\\/admin\",\"__token__\":\"05f359973d115aa5e9b3fc2e7223c5bd\",\"username\":\"admin\",\"captcha\":\"3TUF\",\"keeplogin\":\"1\"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/76.0.3809.100 Safari/537.36', '1566139584');
INSERT INTO `admin_log` VALUES ('31', '1', 'admin', '/admin/index/login?url=%2Fadmin', '登录', '{\"url\":\"\\/admin\",\"__token__\":\"ca73c8711a14475947f555b06fc61f45\",\"username\":\"admin\",\"captcha\":\"pebc\",\"keeplogin\":\"1\"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/76.0.3809.100 Safari/537.36', '1566139591');
...
INSERT INTO `auth_rule` VALUES ('4', 'file', '0', 'addon', 'Addon', 'fa fa-rocket', '', 'Addon tips', '1', '1502035509', '1565099027', '0', 'normal');
...
INSERT INTO `auth_rule` VALUES ('85', 'file', '2', 'general/database', '数据库管理', 'fa fa-database', '', '可在线进行一些简单的数据库表优化或修复,查看表结构和数据。也可以进行SQL语句的操作', '1', '1565095659', '1565095659', '0', 'normal');
INSERT INTO `auth_rule` VALUES ('86', 'file', '85', 'general/database/index', '查看', 'fa fa-circle-o', '', '', '0', '1565095659', '1565095659', '0', 'normal');
INSERT INTO `auth_rule` VALUES ('87', 'file', '85', 'general/database/query', '查询', 'fa fa-circle-o', '', '', '0', '1565095659', '1565095659', '0', 'normal');
INSERT INTO `auth_rule` VALUES ('88', 'file', '85', 'general/database/backup', '备份', 'fa fa-circle-o', '', '', '0', '1565095659', '1565095659', '0', 'normal');
INSERT INTO `auth_rule` VALUES ('89', 'file', '85', 'general/database/restore', '恢复', 'fa fa-circle-o', '', '', '0', '1565095659', '1565095659', '0', 'normal');
INSERT INTO `auth_rule` VALUES ('90', 'file', '2', 'general/crontab', '定时任务', 'fa fa-tasks', '', '类似于Linux的Crontab定时任务,可以按照设定的时间进行任务的执行,目前仅支持三种任务:请求URL、执行SQL、执行Shell', '1', '1565095744', '1565095744', '0', 'normal');
INSERT INTO `auth_rule` VALUES ('91', 'file', '90', 'general/crontab/index', '查看', 'fa fa-circle-o', '', '', '0', '1565095744', '1565095744', '0', 'normal');
INSERT INTO `auth_rule` VALUES ('92', 'file', '90', 'general/crontab/add', '添加', 'fa fa-circle-o', '', '', '0', '1565095744', '1565095744', '0', 'normal');
INSERT INTO `auth_rule` VALUES ('93', 'file', '90', 'general/crontab/edit', '编辑 ', 'fa fa-circle-o', '', '', '0', '1565095744', '1565095744', '0', 'normal');
INSERT INTO `auth_rule` VALUES ('94', 'file', '90', 'general/crontab/del', '删除', 'fa fa-circle-o', '', '', '0', '1565095744', '1565095744', '0', 'normal');
INSERT INTO `auth_rule` VALUES ('95', 'file', '90', 'general/crontab/multi', '批量更新', 'fa fa-circle-o', '', '', '0', '1565095744', '1565095744', '0', 'normal');
INSERT INTO `auth_rule` VALUES ('96', 'file', '2', 'general/logs', '日志管理', 'fa fa-pied-piper-alt', '', '', '1', '1565095801', '1565095801', '0', 'normal');
INSERT INTO `auth_rule` VALUES ('97', 'file', '96', 'general/logs/index', '查看', 'fa fa-circle-o', '', '', '0', '1565095801', '1565095801', '0', 'normal');
INSERT INTO `auth_rule` VALUES ('98', 'file', '96', 'general/logs/del', '删除', 'fa fa-circle-o', '', '', '0', '1565095801', '1565095801', '0', 'normal');
INSERT INTO `auth_rule` VALUES ('99', 'file', '96', 'general/logs/detail', '详情', 'fa fa-circle-o', '', '', '0', '1565095801', '1565095801', '0', 'normal');
...
-- Records of config
-- ----------------------------
INSERT INTO `config` VALUES ('1', 'name', 'basic', 'Site name', '请填写站点名称', 'string', '话充网厅平台', '', 'required', '');
...
INSERT INTO `config` VALUES ('9', 'categorytype', 'dictionary', 'Category type', '', 'array', '{\"default\":\"Default\"}', '', '', '');
INSERT INTO `config` VALUES ('10', 'configgroup', 'dictionary', 'Config group', '', 'array', '{\"basic\":\"Basic\",\"email\":\"Email\",\"dictionary\":\"Dictionary\",\"user\":\"User\"}', '', '', '');
...
CREATE TABLE `order` (
  ...
  `uid` int(11) NOT NULL DEFAULT '0' COMMENT '下游商户ID 来自user表',
  `pay_uid` int(11) NOT NULL DEFAULT '0' COMMENT '上游账号ID',
  `orderid` varchar(100) NOT NULL DEFAULT '' COMMENT '平台订单号 生成唯一ID',
  `out_trade_id` varchar(100) NOT NULL DEFAULT '' COMMENT '下游订单号',
  `trade_id` varchar(100) DEFAULT '' COMMENT '上游订单号',
  `phone` char(20) DEFAULT '',
  `money` decimal(11,4) DEFAULT '0.0000',
  `create_time` int(11) DEFAULT '0',
  `success_time` int(11) DEFAULT '0' COMMENT '订单成功时间',
  `finish_time` int(11) DEFAULT '0' COMMENT '完成时间',
  `status` tinyint(1) DEFAULT '0' COMMENT '0=未完成 1=成功 2=回调完成',
  PRIMARY KEY (`id`),
  UNIQUE KEY `uid_outid` (`uid`,`out_trade_id`),
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES ('1', '1', 'admin', 'admin', '06062e4e3460226193ed9824aed0724a', '1dohpA', 'admin@163.com', '13888888888', '', '0', '0', '2017-04-15', '', '0.00', '0', '1', '1', '1565098447', '1565098508', '127.0.0.1', '0', '127.0.0.1', '1491461418', '0', '1565098508', '', 'normal', '');
...
-- ----------------------------
INSERT INTO `user_group` VALUES ('1', '下游', '11,10,9,12,7,6,5,8,4,2,3,1', '1515386468', '1565098559', 'normal', 'default');
...
-- ----------------------------
INSERT INTO `user_token` VALUES ('6b3a329cf632f7acc9057ed838c9e959b646851e', '1', '1565098508', '1567690508');
