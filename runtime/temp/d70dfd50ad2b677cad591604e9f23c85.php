<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:74:"D:\Legend\php\crawer\public/../application/admin\view\user\group\edit.html";i:1565097527;s:63:"D:\Legend\php\crawer\application\admin\view\layout\default.html";i:1562338655;s:60:"D:\Legend\php\crawer\application\admin\view\common\meta.html";i:1562338655;s:62:"D:\Legend\php\crawer\application\admin\view\common\script.html";i:1562338655;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        <label for="c-name" class="control-label col-xs-12 col-sm-2"><?php echo __('标识'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-code" class="form-control" name="row[code]" type="text" readonly value="<?php echo htmlentities($row['code']); ?>">
        </div>
    </div>
    <div class="form-group">
