<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:70:"D:\Legend\php\crawer\public/../application/index\view\index\index.html";i:1565097971;}*/ ?>
<!DOCTYPE html>
<html>
    ...
    <head>
        ...
        <title><?php echo $site['name']; ?> - <?php echo __('The fastest framework based on ThinkPHP5 and Bootstrap'); ?></title>
        ...
        <nav id="mainNav" class="navbar navbar-default navbar-fixed-top">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand page-scroll" href="#page-top"><?php echo $site['name']; ?><!--<img  src="/assets/img/qrcode.png" style="width:25px;" alt="">--></a>
                </div>
